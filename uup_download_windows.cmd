@echo off
:: Generated on 2025-04-15 22:54:54 GMT
...
:START_PROCESS
title 19045.5794_amd64_en-us_multi_a87c198a download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=a87c198a-68a9-41e3-8bc9-0d0a46be97d4&pack=en-us&edition=core;professional&aria2=2"
