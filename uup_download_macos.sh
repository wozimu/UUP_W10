...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=a87c198a-68a9-41e3-8bc9-0d0a46be97d4&pack=en-us&edition=core;professional&aria2=2"
if [ $? != 0 ]; then
